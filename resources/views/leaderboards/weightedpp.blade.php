    ...
    <div class="relative overflow-x-auto shadow-md rounded-lg fixed flex flex-col justify-between lg:max-w-7xl -translate-x-1/2 w-[calc(100%-2rem)] left-1/2 top-28" style="align-items: center">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <caption
                ...
                Weighted pp leaderboard
                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Weighted pp score across all daily challenges</p>
            </caption>
            ...
            @foreach($leaderboard as $entry)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4">
                        {{number_format($entry->weighted_pp)}}
                    </td>
                </tr>
            @endforeach
            </tbody>
